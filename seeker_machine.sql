...
CREATE TABLE `buckets` (
  ...
  `bucket_volume` int(11) NOT NULL,
  `bucket_volume_in_inches` int(11) NOT NULL COMMENT 'cubic inches',
  `remaining_volume` float NOT NULL,
...
--
-- Table structure for table `fill_buckets`
--

CREATE TABLE `fill_buckets` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `bucket_id` int(11) NOT NULL,
  `ball_id` int(11) NOT NULL,
  `bucket_volume` double(8,2) NOT NULL,
  `bucket_volume_remains` double(8,2) NOT NULL,
  `bucket_contain_cubic_inches` int(11) NOT NULL,
  `ball_value` double(8,2) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(12, '2023_06_28_122459_create_buckets_table', 1),
(13, '2023_06_28_122904_create_balls_table', 1),
(16, '2023_06_28_123135_create_fill_buckets_table', 2);
...
--
-- Indexes for table `fill_buckets`
--
ALTER TABLE `fill_buckets`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `fill_buckets`
--
ALTER TABLE `fill_buckets`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
